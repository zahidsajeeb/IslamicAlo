<!DOCTYPE html>
<html lang="en">
    <?php include 'head_bookdetails.php'; ?>
    <body>
        <div class="wrapper">
...
<!--                                        <div class="clearfix mb-30">
                                            <div class="product-detail-price"><del>TK:39.99</del> <ins> TK: <?php echo $result->ebook_price; ?></ins></div>
                                        ...
                                        <div id="share"></div>
                                        <a style="color:white;" class="btn btn-info btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-mail-forward"> Email</i></a>
                                    </div>
                                </div>
                                                ...
                                                <div class="product">
                                                    ...
                                                    <div class="product-des">
                                                        ...
                                                        <div class="product-price">
                                                            <del>TK:24.99</del> <ins> <?php echo $product->ebook_price; ?> </ins>
                                                        </div>
                                                    </div>
                                                </div> 
                                            </div>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12">
                                    <form action="<?php echo base_url(); ?>index.php/Book/SendMail" method="POST">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="3"> 
                                                        ...
                                                        <input type="hidden"  name="id" value="<?php echo $result->ebooks_id; ?>"> 
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3"> <input type="text" name="subject" class="form-control" readonly="" value="<?php echo $result->ebook_title; ?>">  </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        if ($result->ebook_image != '') {
                                                            ...
                                                            watermarkImage($SourceFile, $WaterMarkText, $DestinationFile);
                                                            ?>
                                                        <img class="img-fluid" style="width:200px; height:250px;" src='<?php echo base_url() . '_images/books/watermark_img/w_' . $result->ebook_image ?>'>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <img class="img-fluid" src="<?php echo base_url(); ?>_images/books/no-book.png" alt="">
                                                        ...
                                                        <h5 class="mb-10"> <?php echo $result->ebook_title; ?> </h5>           
                                                        <span style="font-weight:bold;"> </span> <a> <?php echo $result->author_name; ?></a><br>
                                                        <span style="font-weight:bold;"> Publication: </span> <a>   <?php echo $result->publisher_name; ?></a> <br>
                                                        <span style="font-weight:bold;"> Book ID: </span> <a> <?php echo $result->ebooks_id; ?> </a>
                                                        </div>
