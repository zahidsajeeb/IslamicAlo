                                                    ...
                                                    <td width="90%" align="center">
                                                        <table width="100%" cellpadding="20" cellspacing="0" border="0">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        <div class="col-lg-6" style="float:left; margin-right: 25px;">
<!--                                                                            <div class="slider-slick">-->
                                                                                <?php
                                                                                    if ($result->ebook_image != ''){
                                                                                ?>
                                                                                
                                                                                <img class="img-fluid" style="height:300px; width:250px;" src="<?php echo base_url();?>_images/books/<?php echo $result->ebook_image;?>"></img>
                                                                                        <?php
                                                                                        } else {
                                                                                            ?>
                                                                                <img class="img-fluid" style="height:300px; width:250px;" src="<?php echo base_url(); ?>_images/books/no-book.png" alt="">
                                                                                            <?php
                                                                                            }
                                                                                            ?>
<!--                                                                            </div>-->
...
<!--                                                                            <div class="product-detail clearfix">
                                                                                <div class="product-detail-title mb-20 sm-mt-40">-->
                                                                                    ...
                                                                                    <a>
                                                                                        <?php echo $result->ebooks_id; ?>
                                                                                    </a>
                                                                                    <br>
                                                                                    <span style="font-weight:bold;"> Link: </span>
                                                                                    <a href="<?php echo base_url();?>index.php/Book/BookDetails/<?php echo $result->ebooks_id;?>">
                                                                                        <?php echo base_url();?>index.php/Book/BookDetails/
                                                                                            <?php echo $result->ebooks_id;?>
                                                                                    </a>
<!--                                                                                </div>
                                                                            </div>-->
