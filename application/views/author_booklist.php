                    ...
                    <div class="row"> 
                        <div class="col-lg-12"> 
                            <div class="page-title-name">
                                <h1> <?php echo $author_name->author_name; ?> </h1>
                                <!--<p>We know the secret of your success</p>-->
                            </div>
                            <ul class="page-breadcrumb">
                                <li><a href="#"><i class="fa fa-home"></i> Home</a> <i class="fa fa-angle-double-right"></i></li>
                                <li><a href="#">page</a> <i class="fa fa-angle-double-right"></i></li>
                                <li><span> <?php echo $author_name->author_name; ?> </span> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-40">
                        <div class="col-lg-12"> 
                            ...
                            <div class="accordion accordion-border no-radius mb-20 theme-color" style="padding:0px;">
                                <div class="acd-group">
                                    <a href="#" class="acd-heading" style="background-color:#00b106; color:white;"> <?php echo $author_name->author_name; ?> </a>
                                 <div class="team team-list">
                                    <div class="team-photo">
                                        <img style="height:250px; width:100%;" src="<?php echo base_url();?>_images/auth_details.jpg">
                                    </div>
                            ...
                            <div class="our-service mb-40 pb-0">
                                ...
                                <ul>
                                    ...
                                    foreach ($authors as $author):
                                        ...
                                        ?>
                                        <li>
                                            <a class="gray-bg" style="font-size:13px;" href="<?php echo base_url(); ?>index.php/Book/AuthorBookLists/<?php echo $author->ebook_author_id; ?>"><i class="fa fa-align-left"></i> &nbsp; <?php echo $author->author_name; ?> <span class="float-right">[<?php echo $totalAuth[0]->auth_total ?>]</span> </a>
                                        </li>
                                    <?php endforeach; ?>
