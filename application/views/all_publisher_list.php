                                ...
                                <div class="col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <section>
                                                <h4 class="theme-color my-4 text-center"><b>All Publisher Lists </b></h4>
                                                <div class="divider dashed mb-3"></div>
                                                <div class="icon-list-demo row">
                                                    <?php foreach ($all_publisher_lists as $list):?>
                                                    <div class="col-sm-6 col-md-4 col-lg-3">
                                                        <a href="<?php echo base_url(); ?>index.php/Book/PublisherBookLists/<?php echo $list->publisher_id; ?>"><i class="fa fa-list-ul"></i><?php echo $list->publisher_name;?></a>
                                                    </div>  
                                                    <?php endforeach;?>
