...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Content -->
        <div class="container">
            <h2 style="text-align:left;"> <?php echo $result1->lecturer_name;?> </h2>
            <hr>
            <br>
...
<!--            <div class="row">
                <table class="table table-borderless">
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td style="vertical-align:middle;"> <img style="height:250px; width:300px;" src="<?php echo base_url(); ?>_images/lectur/lecturer/<?php echo $result1->lecturer_img;?>"> </td>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 style="text-align:center;"> Video Lectures ( <?php echo count($result)?> ) </h3> <br>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align:middle;"> 
                                    <a href="<?php echo base_url();?>index.php/AudioVideo/VideoLive/<?php echo $row->file_id;?>" class="btn btn-danger"><i class="fa fa-play"></i> Watch </a>                                    
                                </td>
                                <td style="text-align: center; vertical-align:middle;">
