                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title line text-center center">
                                ...
                                <h2 class="title">Latest Video Lecture </h2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $row):
                                            ...
                                            <tr>
                                                ...
                                                <td>   <a href="<?php echo base_url(); ?>index.php/AudioVideo/LecturerAaudioLists/<?php echo $row->lecturer_id; ?>"href="" class="btn btn-md btn-danger"> <i class="fa fa-headphones"></i> Audio Lectures</a></td>
                                            </tr>
                                        <?php endforeach; ?>
